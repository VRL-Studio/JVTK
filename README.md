...
- Copy the content of `$CMAKE_INSTALL_PREFIX/vtk-5.10/bin` to `JVTK/natives` (The concrete install folder depends
  on the VTK version and OS). It is suggested to manually choose the preferred location, e.g., `/home/user/vtk`)
  > **NOTE**
